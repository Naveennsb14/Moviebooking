...
const popupDuration = document.querySelector(".popup-duration");
...
movieCards.forEach((movieCard) => {
  movieCard.addEventListener("click", () => {
    ...
    populatePopupWithMovieData(movieData);
    showPopup();
  });
});
...
function showConfirmation() {
  checkout.innerHTML =
    "<h2>Payment Successful!</h2><p>Thank you for booking tickets.</p>";
}